...
function Formulario({
    ...
    return ( <
        ...
        alt = "Imagem cachorro" / >
        <
        img src = { MinhaImagem2 }
        alt = "Imagem cachorro2" / >
        <
        img src = { MinhaImagem3 }
        alt = "Imagem cachorro3" / >
        <
        /div> <
        div className = "form" >
        <
        ...
        div className = "title" >
        <
        h1 > Formulário de consulta - Melhor PetShop < /h1> <
        /div> <
        /div> <
        ...
        input id = "caesPequenos"
        type = "number"
        name = "caesPequenos"
        placeholder = "Digite a quantidade de Cães Pequenos"
        value = { caesPequenos }
        onChange = {
            ({ target: { value } }) => setCaesPequenos(value) }
        required /
        >
        <
        /div> <
        ...
        input id = "caesGrandes"
        type = "number"
        name = "caesGrandes"
        placeholder = "Digite a quantidade de Cães Grandes"
        value = { caesGrandes }
        onChange = {
            ({ target: { value } }) => setCaesGrandes(value) }
        required /
        >
        <
        /div> <
        ...
        br / > {
            melhorCanil && ( <
                div >
                O melhor PetShop é < strong > { melhorCanil.nome } < /strong> com um custo total de {' '} <
